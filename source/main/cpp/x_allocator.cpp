...
namespace ncore
{
    ...
    u32 allocinplace_t::v_deallocate(void* p) { return 0; }
    ...
    fsadexed_array_t::fsadexed_array_t() : m_data(nullptr), m_sizeof(0), m_countof(0), m_freelist(0xffffffff), m_freeindex(0xffffffff) {}

    fsadexed_array_t::fsadexed_array_t(void* array_item, u32 sizeof_item, u32 countof_item) : m_data(array_item), m_sizeof(sizeof_item), m_countof(countof_item), m_freelist(0xffffffff), m_freeindex(0)
    {
