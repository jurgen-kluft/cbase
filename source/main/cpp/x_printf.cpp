...
#define to_char(n) ((u32)((n) + '0'))
        ...
        reswitch:
            switch (ch)
            {
                ...
                case 's':
                    ...
                    {
                        utf32::crunes src = *(utf32::crunes const*)args[argindex];
                    ...
                    {
                        ascii::crunes src = *(ascii::crunes const*)args[argindex];
                        while (utf::can_read(src))
                        {
                            uchar32 c = utf::read(src);
                            buffer->Write(c);
    ...
    namespace ascii
    {
        ...
        {
            utf32::runez<256> line;
            utf::copy(str, line);
            return console->write(line);
        }
    ...
    namespace utf32
    {
        ...
        void printf(crunes const& str) { return console->write(str); }
