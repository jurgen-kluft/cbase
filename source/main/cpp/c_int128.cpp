...
namespace ncore
{
    ...
    s128::s128(const s128& value) { *this = value; }
    ...
    bool s128::IsNegative() const { return bool((m_MSB & 0x80000000) != 0); }

    bool s128::IsPositive() const { return bool((m_MSB & 0x80000000) == 0); }
