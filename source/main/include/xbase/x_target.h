...
//
///
#if !defined(TARGET_MAC_DEV_DEBUG) && !defined(TARGET_MAC_DEV_DEV) && !defined(TARGET_MAC_DEV_RELEASE) && !defined(TARGET_MAC_DEV_FINAL) && !defined(TARGET_MAC_CLIENT_DEBUG) && !defined(TARGET_MAC_CLIENT_DEV) && !defined(TARGET_MAC_CLIENT_RELEASE) && \
    !defined(TARGET_MAC_CLIENT_FINAL) && !defined(TARGET_MAC_RETAIL_DEBUG) && !defined(TARGET_MAC_RETAIL_DEV) && !defined(TARGET_MAC_RETAIL_RELEASE) && !defined(TARGET_MAC_RETAIL_FINAL)
#    ifdef TARGET_MAC
...
#    define NULL 0
    ...
    const u64 xKBB = (u64)(1024 >> 8); // e.g 0x0180 * xKBB = 1.5 KB, 0x0140 * xKBB = 1.25 KB
    const u64 xMBB = (u64)((1024 * 1024) >> 8);
