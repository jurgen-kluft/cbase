...
#    define X_INTU_OPTIMIZED
    ...
    inline bool xisAligned(u32 integer, u32 alignment); ///< Return xTRUE if integer is aligned
    ...
    inline bool xispo2(s32 integer);                    ///< Check if integer is a power-of-two
    inline bool xispo2(u32 integer);                    ///< Check if integer is a power-of-two
    inline bool xispo2(u64 integer);                    ///< Check if integer is a power-of-two
    ...
    inline s8  xcountBits(u8 integer);                ///< count one bits in 8 bit word
    inline s8  xcountBits(u16 integer);                ///< count one bits in 16 bit word
