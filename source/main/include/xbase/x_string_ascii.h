...
namespace xcore
{
	...
	/// UTF8 and UTF16
	extern u32			x_strAsciiToUTF8		( uchar8* szDst, const char* szSrc );
	extern u32			x_strUTF16ToUTF8		( uchar8* szDst, const uchar16* wszSrc );
	...
	extern bool			x_strIsQuoted			(const char* inStr, char quote='\"', s32 inStrLen=-1);						///< Check if string is enclosed in double quotes
