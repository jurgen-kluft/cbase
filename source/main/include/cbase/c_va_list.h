...
namespace ncore
{
    ...
    public:
        ...
        explicit va_t(s8 inVar)
            : mArg3(TYPE_INT8)
        {
            *(s8*)&mArg = inVar;
        }
        explicit va_t(u8 inVar)
            : mArg3(TYPE_UINT8)
        {
            *(u8*)&mArg = inVar;
        }
        explicit va_t(s16 inVar)
            : mArg3(TYPE_INT16)
        {
            *(s16*)&mArg = inVar;
        }
        explicit va_t(u16 inVar)
            : mArg3(TYPE_UINT16)
        {
            *(u16*)&mArg = inVar;
        }
        ...
        explicit va_t(s64 inVar)
            : mArg3(TYPE_INT64)
        {
            *(s64*)&mArg = inVar;
        }
        explicit va_t(u64 inVar)
            : mArg3(TYPE_UINT64)
        {
            *(u64*)&mArg = inVar;
        }
        explicit va_t(bool inVar)
            : mArg3(TYPE_BOOL)
        {
            *(u32*)&mArg = inVar ? 1 : 0;
        }
        explicit va_t(f32 inVar)
            : mArg3(TYPE_FLOAT32)
        {
            *(f32*)&mArg = inVar;
        }
        explicit va_t(f64 inVar)
            : mArg3(TYPE_FLOAT64)
        {
            *(f64*)&mArg = inVar;
        }
