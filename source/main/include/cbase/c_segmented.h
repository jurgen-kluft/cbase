#ifndef __CBASE_SEGMENTED_H__
#define __CBASE_SEGMENTED_H__
...
namespace ncore
{
    ...
    template <typename T>
    void segmented_t<T>::setup(alloc_t* allocator, u64 address_range, u8 node_count_2log)
    {
    ...
    template <typename T>
    void segmented_t<T>::teardown(alloc_t* allocator)
    {
    ...
    template <typename T>
    bool segmented_t<T>::split(node_t node)
    {
    ...
    template <typename T>
    void segmented_t<T>::add_size(u8 index, node_t node)
    {
    ...
    template <typename T>
    void segmented_t<T>::remove_size(u8 index, node_t node)
    {
    ...
    template <typename T>
    bool segmented_t<T>::allocate(u64 _size, u64& out_address)
    {
    ...
    template <typename T>
    bool segmented_t<T>::deallocate(u64 address)
    {
