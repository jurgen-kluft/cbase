...
namespace ncore
{
    ...
    extern array_memory_t* g_get_default_array_memory_handler();
    ...
    public:
        ...
        static array_t<T>* create(u32 initial_size, u32 initial_capacity, array_memory_t* memory = nullptr)
        {
            if (memory == nullptr)
        ...
        inline bool set_capacity(u32 capacity) { return m_memory->set_capacity((void*&)m_items, sizeof(T), m_size, m_cap_cur, capacity); }

        inline u32  size() const { return m_size; }
        inline void set_size(u32 size) { m_size = size; }
        inline u32  cap_cur() const { return m_cap_cur; }
        inline u32  cap_max() const { return m_memory->max_capacity(); }
    ...
    protected:
        ...
        ~array_t() { m_memory->set_capacity((void*&)m_items, sizeof(T), m_size, m_cap_cur, 0); }

        T*              m_items;
        array_memory_t* m_memory;
        u32             m_size;
        u32             m_cap_cur;
    };
