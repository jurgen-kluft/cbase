namespace ncore
{
    namespace math
    {
        ...
        // If 'integer == 0' this function will return 0
        inline s32 xfindFirstBit(u16 integer) { return xcountTrailingZeros(integer); }

        // find the bit position/index of the first bit from high to low
        // If 'integer == 0' this function will return -1
        inline s32 xfindLastBit(u16 integer) { return 15 - xcountLeadingZeros(integer); }

        // find the bit position/index of the first bit from low to high
        // If 'integer == 0' this function will return 0
        inline s32 xfindFirstBit(u32 integer) { return xcountTrailingZeros(integer); }

        // find the bit position/index of the first bit from high to low
        // If 'integer == 0' this function will return -1
        inline s32 xfindLastBit(u32 integer) { return 31 - xcountLeadingZeros(integer); }

        // find the bit position/index of the first bit from low to high
        // If 'integer == 0' this function will return 0
        inline s32 xfindFirstBit(u64 integer) { return xcountTrailingZeros(integer); }

        // find the bit position/index of the first bit from high to low
        // If 'integer == 0' this function will return -1
        inline s32 xfindLastBit(u64 integer) { return 63 - xcountLeadingZeros(integer); }
