...
namespace ncore
{
	...
	// If 'integer == 0' this function will return -1
	inline s8 xfindLastBit(u16 integer)
	{
	...
	// find the bit position/index of the first bit from high to low
	// If 'integer == 0' this function will return -1
	inline s8 xfindLastBit(u32 integer)
	{
	...
	// find the bit position/index of the first bit from high to low
	// If 'integer == 0' this function will return -1
	inline s8 xfindLastBit(u64 integer)
	{
