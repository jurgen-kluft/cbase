...
namespace ncore
{
    namespace math
    {
        ...
        inline s8 xcountTrailingZeros(u16 v)
        {
        ...
        // if 'v==0' this function returns 0
        inline s8 xcountTrailingZeros(u32 v)
        {
            unsigned long result;
            ::_BitScanForward(&result, v);
            return (s8)result;
        ...
        // if 'v==0' this function returns 0
        inline s8 xcountTrailingZeros(u64 v)
        {
            unsigned long result;
         ...
         * count one bits in 32 bit word
         */
        inline s8 xcountBits(u16 inInteger) { return (s8)__popcnt16(inInteger); }

        /**
         * count one bits in 32 bit word
         */
        inline s8 xcountBits(u32 inInteger) { return (s8)__popcnt(inInteger); }

        /**
         * count one bits in 64 bit word
         */
        inline s8 xcountBits(u64 inInteger) { return (s8)__popcnt64(inInteger); }
    } // namespace math
}