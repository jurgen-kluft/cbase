...
namespace math
{
    ...
    {
        u64 f = (u64)DD_SIGN_MASK;
        return *(f64*)&f;
    }
#ifdef D_IEEE_FLOATS
    inline f64 nan64()
    {
        u64 f = (u64)(DD_EXPONENT_MASK | 1);
        return *(f64*)&f;
    }
    inline f64 positiveInfinity64()
    {
        u64 f = (u64)(DD_EXPONENT_MASK);
        return *(f64*)&f;
    }
    inline f64 negativeInfinity64()
    {
        u64 f = (u64)(DD_SIGN_MASK | DD_EXPONENT_MASK);
        return *(f64*)&f;
    }
#endif
    inline f64 positiveMaximum64()
    {
        u64 f = (u64)(((DD_MAX_EXPONENT_BIAS - 1) << DD_GET_EXPONENT_SHIFT) | DD_FRACTION_MASK);
        return toF64(f);
    }
    inline f64 negativeMaximum64()
    {
        u64 f = (u64)((DD_SIGN_MASK | ((DD_MAX_EXPONENT_BIAS - 1) << DD_GET_EXPONENT_SHIFT)) | DD_FRACTION_MASK);
        return toF64(f);
    }
    inline f64 positiveMinimum64()
    {
        u64 f = (u64)((u64)(1) << DD_GET_EXPONENT_SHIFT);
        return toF64(f);
    }
    inline f64 negativeMinimum64()
    {
        u64 f = (u64)(DD_SIGN_MASK | ((u64)1 << DD_GET_EXPONENT_SHIFT));
        return toF64(f);
    }
    ...
    {
        u64 f = (u64)((u64)1 << (DD_FRACTION_BITS - 1));
        return toF64(f);
    }
    inline f64 negativeMinimumDEN64()
    {
        u64 f = (u64)(DD_SIGN_MASK | ((u64)1 << (DD_FRACTION_BITS - 1)));
        return toF64(f);
    }
