...
UNITTEST_SUITE_BEGIN(tblfmt)
{
    UNITTEST_FIXTURE(tblfmt)
    {
        ...
        UNITTEST_TEST(simple)
        {
            ...
            table.widths(20, 15, 10, 4);  // set the widths of the columns
            ...
            table.row("hello", "hello", "a very large constant", "constant");
            UnitTest::Stdout::Trace(table.str_utf8());
            ...
            table.row("world", "world", 3.141599f, 3.141588f);
