...
UNITTEST_SUITE_BEGIN(test_int64)
{
    UNITTEST_FIXTURE(main)
    {
        ...
        UNITTEST_TEST(Constructors)
        {
			...
			__xint64 v72(D_CONSTANT_64(0x12345678ABCDEF33));
			CHECK_EQUAL(D_CONSTANT_64(0x12345678ABCDEF33), (u64)v72);

			__xint64 v81(7,8);
			CHECK_EQUAL(D_CONSTANT_64(0x0000000700000008), (u64)v81);
		}
		...
		UNITTEST_TEST(Asignment)
		{
			...
			CHECK_EQUAL(7, (u64)v71);
			__xint64 v72; v72 = (D_CONSTANT_64(0x12345678ABCDEF33));
			CHECK_EQUAL(D_CONSTANT_64(0x12345678ABCDEF33), (u64)v72);
		}
		...
		UNITTEST_TEST(Increment)
		{
			...
			__xint64 v2(D_CONSTANT_64(0x00000000FFFFFFFF));
			CHECK_EQUAL(D_CONSTANT_64(0x00000000FFFFFFFF), (u64)v2);
			v2++;
			CHECK_EQUAL(D_CONSTANT_64(0x0000000100000000), (u64)v2);
			++v2;
			CHECK_EQUAL(D_CONSTANT_64(0x0000000100000001), (u64)v2);
		}
		...
		UNITTEST_TEST(Decrement)
		{
			...
			__xint64 v2(D_CONSTANT_64(0x0000000100000000));
			CHECK_EQUAL(D_CONSTANT_64(0x0000000100000000), (u64)v2);
			v2--;
			CHECK_EQUAL(D_CONSTANT_64(0x00000000FFFFFFFF), (u64)v2);
			--v2;
			CHECK_EQUAL(D_CONSTANT_64(0x00000000FFFFFFFE), (u64)v2);
		}
