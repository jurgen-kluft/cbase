...
UNITTEST_SUITE_BEGIN(xstring_utf)
{
    UNITTEST_FIXTURE(utf8)
    {
        ...
        {
            const uchar   str[] = {0x66, 0x72, (uchar)0xC3, (uchar)0xA9, 0x6E, 0x63, 0x68, 0x0}; // fr�nch
        ...
        {
            const uchar   str[] = {0x66, 0x72, (uchar)0xE9, 0x6E, 0x63, 0x68, 0x0}; // frénch
            ascii::crunes src(str);
        ...
        {
            const uchar8 str[] = {0x66, 0x72, 0xC3, (uchar8)0xA9, 0x6E, 0x63, 0x68, 0x0}; // fr�nch
            utf8::crunes src(str);
            CHECK_EQUAL('f', utf::read(src));
            CHECK_EQUAL('r', utf::read(src));
            CHECK_EQUAL(0xE9, utf::read(src));
