...
UNITTEST_SUITE_BEGIN(memory)
{
	UNITTEST_FIXTURE(main)
	{
		...
		UNITTEST_TEST(readunaligned16)
		{
			...
			CHECK_EQUAL((ncore::uint_t)2, (ncore::uint_t)ptr - (ncore::uint_t)&buffer1[1]);
			CHECK_EQUAL((u16)0x0708, r);
		}
		...
		UNITTEST_TEST(readunaligned24)
		{
			...
			CHECK_EQUAL((ncore::uint_t)3, (ncore::uint_t)ptr1 - (ncore::uint_t)&buffer1[1]);
			CHECK_EQUAL((u32)0x070809, r1);
			ncore::u32 r2;
			ncore::u32 const* ptr2 = nmem::readunaligned24((ncore::u32 const*)&buffer1[2], r2);
			CHECK_EQUAL((ncore::uint_t)3, (ncore::uint_t)ptr2 - (ncore::uint_t)&buffer1[2]);
			CHECK_EQUAL((u32)0x08090a, r2);
		}
		...
		UNITTEST_TEST(readunaligned32)
		{
			...
			CHECK_EQUAL((ncore::uint_t)4, (ncore::uint_t)ptr1 - (ncore::uint_t)&buffer1[1]);
			CHECK_EQUAL((u32)0x0708090a, r1);
			ncore::u32 r2;
			ncore::u32 const* ptr2 = nmem::readunaligned32((ncore::u32 const*)&buffer1[2], r2);
			CHECK_EQUAL((ncore::uint_t)4, (ncore::uint_t)ptr2 - (ncore::uint_t)&buffer1[2]);
			CHECK_EQUAL((u32)0x08090a01, r2);
		}
	}
}
UNITTEST_SUITE_END
